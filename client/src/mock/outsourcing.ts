...
export const outsourceOrderData: IOutsourceOrder[] = [
    ...
    { id: 2, outsourceNo: 'WW-20231120-001', entrustmentId: '202311002', sampleIds: ['S2023110201'], sampleCount: 1, supplierId: 'SUP002', supplierName: '中国检验认证集团', pricePerSample: 800, totalPrice: 800, approvalStatus: '待审批', status: '待确认', assignedBy: '张鑫明', assignDate: '2023-11-20' },
];
...
export const outsourceParameterData: IOutsourceParameter[] = [
    ...
    { id: 2, outsourceNo: 'WW-20231122-001', parameterId: 5, parameterName: '金相组织', sampleIds: ['S2023110401'], supplierId: 'SUP002', supplierName: '中国检验认证集团', pricePerSample: 600, totalPrice: 600, qualifiedSuppliers: ['SUP002', 'SUP004'], approvalStatus: '已通过', approvalId: 'DD-20231122-001', status: '已完成', assignedBy: '武基勇', assignDate: '2023-11-22', remark: '加急处理' },
];
