...
export const entrustmentData: IEntrustmentRecord[] = [
    { id: 1, entrustmentId: '202211001', reportId: 'w-2022-ALTC-TC-001', sampleDate: '22.11.08', testDate: '22.11.09', sampleName: '热轧板', sampleIds: ['S20231101001'], testItems: '金属拉伸、弯曲', follower: '吴凡', assignmentMode: 'automatic', contractNo: 'CT20221101' },
    { id: 2, entrustmentId: '202211002', reportId: 'w-2022-ALTC-TC-002', sampleDate: '22.11.21', testDate: '22.11.22', sampleName: '聚丙烯', sampleIds: ['S20231101002'], testItems: '塑料机械、热性能的测定...', follower: '吴凡', assignmentMode: 'manual', contractNo: 'CT20221102' },
    { id: 3, entrustmentId: '202211003', reportId: 'w-2022-ALTC-TC-003', sampleDate: '22.11.28', testDate: '22.11.29', sampleName: '橡胶', sampleIds: [], testItems: '橡胶拉伸、撕裂', follower: '吴凡', assignmentMode: 'automatic', contractNo: 'CT20221103' },
    { id: 4, entrustmentId: '202212001', reportId: 'w-2022-ALTC-TC-004', sampleDate: '22.12.06', testDate: '22.12.07', sampleName: '聚丙烯', sampleIds: [], testItems: '塑料机械、热性能的测定...', follower: '吴凡', assignmentMode: 'manual', contractNo: 'CT20221201' },
    { id: 5, entrustmentId: '202212002', reportId: 'w-2022-ALTC-TC-005', sampleDate: '22.12.13', testDate: '22.12.14', sampleName: '热轧板', sampleIds: [], testItems: '金属拉伸、弯曲', follower: '吴凡', assignmentMode: 'automatic', contractNo: 'CT20221202' },
    { id: 6, entrustmentId: '202304001', reportId: 'w-2023-ALTC-TC-010', sampleDate: '23.4.07', testDate: '23.4.10', sampleName: '指淀板支架总成圆管', sampleIds: [], testItems: '金相组织珠光体组织评定', follower: '张鑫明', assignmentMode: 'manual', contractNo: 'CT20230401' },
    { id: 7, entrustmentId: '202304003', reportId: 'w-2023-ALTC-TC-012', sampleDate: '23.4.10', testDate: '23.4.11', sampleName: '座椅头枕杆', sampleIds: [], testItems: '中性盐雾', follower: '刘丽愉', assignmentMode: 'automatic', contractNo: 'CT20230403' },
    ...
    { id: 12, entrustmentId: '202311002', reportId: 'w-2023-ALTC-TC-097', sampleDate: '23.11.27', testDate: '23.11.28', sampleName: '工业废水', sampleIds: ['S20231127001'], testItems: 'pH值', follower: '张三', assignmentMode: 'manual', contractNo: 'CT20231102' },
];
