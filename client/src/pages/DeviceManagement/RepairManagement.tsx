...
import { Table, Card, Button, Modal, Form, Input, Select, DatePicker, Space, Tag, message, Popconfirm, InputNumber } from 'antd';
import type { ColumnsType } from 'antd/es/table';
import { PlusOutlined } from '@ant-design/icons';
import { repairRecordData, deviceData } from '../../mock/devices';
import type { IRepairRecord } from '../../mock/devices';
