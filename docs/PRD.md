...
**页面路径**：`/sample-management/receipt`
...
**页面路径**：`/sample-management/details`
...
**页面路径**：`/sample-management/my-samples`
...
**页面路径**：`/task-management/all-tasks`
...
**页面路径**：`/test-management/data-entry`
...
**页面路径**：`/report-management/test-reports`
...
**页面路径**：`/report-management/client-reports`
...
**页面路径**：`/report-management/approval`
...
**页面路径**：`/report-management/report-templates`
...
**页面路径**：`/finance-management/receivables`
...
**页面路径**：`/finance-management/payment-records`
...
**页面路径**：`/finance-management/invoices`
...
**页面路径**：`/device-management/maintenance`
...
**页面路径**：`/device-management/calibration`
...
**页面路径**：`/statistics-report/entrustment`
...
**页面路径**：`/system-settings/departments`
...
**页面路径**：`/system-settings/permission`

#### 3.9.5 审批流程配置 (ApprovalWorkflowConfig)

**页面路径**：`/approval-workflow`
...
**页面路径**：`/supplier-management/info`

#### 3.10.2 供应商分类 (SupplierCategory)

**页面路径**：`/supplier-management/category`

#### 3.10.3 评价模板 (EvaluationTemplate)

**页面路径**：`/supplier-management/template`

#### 3.10.4 绩效评价 (PerformanceEvaluation)

**页面路径**：`/supplier-management/evaluation`
...
**页面路径**：`/consumables-management/info`

#### 3.11.2 出入库记录 (StockTransactions)

**页面路径**：`/consumables-management/transactions`
...
**页面路径**：`/outsourcing-management/all`

#### 3.12.2 我的委外 (MyOutsourcing)

**页面路径**：`/outsourcing-management/my`
